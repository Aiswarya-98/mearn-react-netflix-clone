...
function Home() {
  ...
  const handleSubmit = (event) => {
    ...
    if (!email.trim()) {
      // If email is empty, show an alert
  ...
  return (
    <>
      ...
      <div className="header">
        <nav>
          <img src="https://th.bing.com/th/id/R.2ea85d7448475a744c1485c2eac3d3d1?rik=LOSTtarBPEnY%2fw&riu=http%3a%2f%2fwww.freepnglogos.com%2fuploads%2fnetflix-logo-0.png&ehk=PaZLUHaWmwAMEzdIDx7zGpBu053ZpXipTljxBidJnfU%3d&risl=&pid=ImgRaw&r=0" alt="" className="logo" />
        ...
        <ul className="accordion">
          ...
          <li>
            ...
            <div className="content">
              <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Saepe officiis autem iure iusto molestiae voluptatibus, deserunt minus atque laborum pariatur rem? Architecto voluptatum facilis, quisquam mollitia aliquid tempore sit illum.</p>
            </div>
          </li>
